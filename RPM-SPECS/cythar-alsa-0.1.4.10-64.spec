...
Summary: CYTHAR Sequenzer, a MIDI Sequencer - Jack & Alsa - 0.1.4.10 - 64bit
Version: 0.1.4.10
Release: 1
License: Other
...
cat > %{buildroot}%{_datadir}/applications/cythar-alsa_64.desktop << EOF
[Desktop Entry]
  Encoding=UTF-8
  Name=cythar-64-alsa
  GenericName=CYTHAR Sequenzer - Alsa - 64
  Comment=CYTHAR MIDI Sequenzer - Alsa - 0.1.4.10
  Exec=cythar-alsa_64_0.1.4.10
  Terminal=false
#Terminal=false
...
%{buildroot}%{_datadir}/applications/cythar-alsa_64.desktop

#Desktopfile for Jack
mkdir 	-p %{buildroot}%{_datadir}/applications
cat > %{buildroot}%{_datadir}/applications/cythar-jack_64.desktop << EOF
[Desktop Entry]
  Encoding=UTF-8
  Name=cythar-64-jack
  GenericName=CYTHAR Sequenzer - Jack - 64
  Comment=CYTHAR MIDI Sequenzer - Jack - 0.1.4.10
  Exec=cythar-jack_64_0.1.4.10
  Terminal=false
#Terminal=true
#TerminalOptions=\s--noclose
  Type=Application
...
desktop-file-install --vendor="" 	\
  ...
  --add-category="AudioVideo" 	\
  --dir %{buildroot}%{_datadir}/applications \
%{buildroot}%{_datadir}/applications/cythar-jack_64.desktop
...
/usr/share/applications/cythar-alsa_64.desktop
/usr/share/applications/cythar-jack_64.desktop
/usr/bin/cythar-alsa_64_0.1.4.10
/usr/bin/cythar-jack_64_0.1.4.10
